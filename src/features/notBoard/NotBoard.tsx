...
import { PlayerSelectChoice, selectActiveChoice, selectGameResult } from "../game/gameSlice"
...
export const NotBoard = ({ leaveGame }: { leaveGame: () => Promise<void> }) => {
  ...
  const obscureClass = canObscureHand ? styles.obscureHand : styles.obscurePlayArea;
