...
import { PartialPlayerState, selectActivePlayer, selectOpponents } from "../board/boardSlice";
...
export const Opponent = ({ opponent }: { opponent: PartialPlayerState }): JSX.Element => {
  const activePlayer = useAppSelector(selectActivePlayer);
  return <div className={`${styles.opponentFrame} ${activePlayer === opponent.playerId ? styles.active : ""}`}>
